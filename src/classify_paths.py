...
def create_array_wlabels(word_list, fixations_list, n, flag):
...
if __name__ =='__main__':
	...
	X_train, Y_train = create_array_wlabels(word_list, fixations_list, 100, True)
